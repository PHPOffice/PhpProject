<?php
/**
 * $Id: bootstrap.php 2892 2011-08-14 15:11:50Z markbaker@PHPProject.net $
 *
 * @copyright   Copyright (C) 2011-2012 PHPProject. All rights reserved.
 * @package     PHPProject
 * @subpackage  PHPProject Unit Tests
 * @author      Mark Baker
 */
 ...
 */
echo "PHPProject tests beginning\n";
